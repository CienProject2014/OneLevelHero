...
public class VillageStage extends Stage {
	...
	private void setVillage() {
		...
		Image backgroundUp = new Image(villageInfo.getBackgroundUp());
		Image backgroundDown = new Image(villageInfo.getBackgroundDown());

		backgroundUp.setBounds(0, 0, viewportWidth, viewportHeight);
		addActor(backgroundUp);
		backgroundDown.setBounds(0, 0, viewportWidth, viewportHeight);
		addActor(backgroundDown);
