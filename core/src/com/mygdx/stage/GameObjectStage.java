...
public class GameObjectStage extends BaseOneLevelStage {
	...
	public void setScene() {
		List<String> greetingMessageList = eventManager.getCurrentGameObject().getGreetingMessages();
		...
		EventElement eventElement = eventManager.getCurrentGameObject();
