...
public class WorldMapStage extends OverlapStage {
	...
	public void setCamera() {
		...
		int xLeftLimit = (int) (width / 2);
		int xRightLimit = (int) (3000 - (width / 2));
		int yBottomLimit = (int) (height / 2);
		int yTopLimit = (int) (1688 - (height / 2));

		float xvalue = this.getCurrent().getX() - width / 2, yvalue = this
				.getCurrent().getY() - height / 2;
		// x값이 오른쪽으로 벗어날 경우
