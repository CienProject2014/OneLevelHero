...
import com.mygdx.loader.MonsterLoader;
...
//	private Hero heros[];					// 영웅 객체
	...
	private void initialize() {
		...
		monster1 = new Table(Assets.skin); monster1.setBackground(Assets.start_after);
		monster2 = new Table(Assets.skin); monster2.setBackground(Assets.option_after);
		monster3 = new Table(Assets.skin); monster3.setBackground(Assets.extra_after);
