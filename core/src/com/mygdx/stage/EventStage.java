...
public class EventStage extends BaseOneLevelStage {
	...
	public Stage makeStage(EventScene eventScene) {
		...
		script.setWrap(true);
		script.setSize(StaticAssets.windowWidth * 0.781f, StaticAssets.windowHeight * 0.185f);
		script.setPosition(StaticAssets.windowWidth * 0.309375f, StaticAssets.windowHeight * 0.185f);
		characterImage.setSize(StaticAssets.windowWidth * 0.250f, StaticAssets.windowHeight * 0.555f);
		characterImage.setPosition(StaticAssets.windowWidth * 0.375f, StaticAssets.windowHeight * 0.185f);
		backgroundImage.setSize(StaticAssets.windowWidth, StaticAssets.windowHeight);
	...
	private void makeSelectStage() {
		...
		script.setSize(StaticAssets.windowWidth * 0.781f, StaticAssets.windowHeight * 0.185f);
		script.setPosition(StaticAssets.windowWidth * 0.109375f, StaticAssets.windowHeight * 0.185f);
		characterImage.setSize(StaticAssets.windowWidth * 0.250f, StaticAssets.windowHeight * 0.555f);
		characterImage.setPosition(StaticAssets.windowWidth * 0.375f, StaticAssets.windowHeight * 0.37f);
		backgroundImage.setSize(StaticAssets.windowWidth, StaticAssets.windowHeight);
	}
	...
	private void makeChatStage() {
		...
		script.setSize(StaticAssets.windowWidth * 0.8f, StaticAssets.windowHeight * 0.3f);
		characterImage.setSize(StaticAssets.windowWidth * 0.2f, StaticAssets.windowHeight * 0.2f);
