...
public class MenuScreen implements Screen {
	...
	BitmapFont font;
	public static Sound sound = Gdx.audio.newSound(Gdx.files
	...
	public void show() {
		...
		// table.debug();
		table.add(startButton).expand().width(realwidth).height(realheight)
				.top().left();
		// table.add(Assets.logo).center();
		table.add(optionsButton).width(realwidth).height(realheight).top()
				.right();
		table.row();
		table.add(creditButton).width(realwidth).height(realheight).bottom()
				.left();
		table.add(collectionButton).width(realwidth).height(realheight)
				.bottom().right();
