...
public class LoadingBarScreen extends BaseScreen {
	...
	public void show() {
		...
		game.assetManager.load("texture/loading/loading.pack",
				TextureAtlas.class);
		...
		stage = new Stage();
		TextureAtlas atlas = game.assetManager
				.get("texture/loading/loading.pack", TextureAtlas.class);
	...
	public void render(float delta) {
		...
		if (game.assetManager.update() && StaticAssets.update()
				&& Assets.update()) {
