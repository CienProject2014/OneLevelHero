...
public class ChangePartyPopup extends Dialog {
	...
	public ChangePartyPopup(String title, Skin skin) {
		super(title, skin);
	}
	...
	public ChangePartyPopup button(String buttonText, InputListener listener) {
