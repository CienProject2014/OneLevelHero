 ...
 * 9E%91%ED%99%9C%EB%8F%99:%EA%B7%B8%EB%9E%98%ED%94%BD_%EC%9E%91%EC%97%85%EB%AC%BC_%EB%AA%85%EB%AA%85
 * % E A % B 7 % 9 C % E C % B 9 % 9 9
 * 
 * @author Velmont
 * 
 */
public class TextureManager {
	...
	public static Texture getBustTexture(String facePath, String faceNumber) {
		return StaticAssets.characterTextureMap.get(TextureEnum.BUST + "_"
				+ facePath + "_" + faceNumber);
	}
