...
public class PartyManager {
	...
	public int getPlayerOrder(Hero hero) {
		for (int i = 0; i < getBattleMemberList().size(); i++) {
			if (getBattleMemberList().get(i).equals(hero)) {
				return i;
			}
		}
		Gdx.app.log("PartyManager", "파티 index정보 오류");
		return -1;
	}
