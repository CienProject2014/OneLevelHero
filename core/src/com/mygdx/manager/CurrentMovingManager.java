...
public class CurrentMovingManager {
	...
	/** 월드맵 정보에서 roadLength, startNode, destination, roadMonster 정보를 CurrentState의 CurrentMovingInfo에 전달한다. */
	public static void createCurrentMovingInfo(String destinationNode) {
		currentMovingInfo.setStartNode(currentPosition.getCurrentNode());
