...
public enum ScreenEnum {
	BUILDING("building"), DUNGEON("dungeon"), DUNGEON_ENTRANCE(
			...
			"world_map"), CREDIT("credit"), EXTRA("extra"), SAVE("save"), BONUS_POINT(
			"bonus_point"), LOAD("load"), EVENT("event"), MOVING("moving"), ENDING(
			"ending"), CG("cg"), BGM("bgm"), COLLECTION("collection"), STATUS(
			"status"), BATTLE("battle"), ENCOUNTER("encounter");
