...
public enum EventTypeEnum {
	START_BATTLE("start_battle"), CHAT("chat"), CHOICE_OPTION("choice_option"), SELECT_EVENT("select_event"), CREDIT(
			"credit"), MOVE_FIELD("move_field"), MOVE_NODE("move_node"), NEXT_SECTION("next_section"), BATTLE_COMMAND(
			"battle_command"), PLAY_MUSIC("play_music"), SAVE("save"), BATTLE_END("battle_end"), PASS_TIME("pass_time"), COLLECT_EVENT(
