...
public enum JsonEnum {
	HERO_JSON("hero_json"), VILLAGE_JSON("village_json"), NPC_JSON("npc_json"), WORLDMAP_JSON("worldmap_json"), CREDIT_LIST(
			"credit_list"), SKIN("skin"), DUNGEON_JSON("dungeon_json"), ATLAS_UI_PATH("atlas_ui_path"), BACKGROUND_FILE_PATH(
			"background_file_path"), CHARACTER_FILE_PATH("character_file_path"), WEAPON_JSON("weapon_json"), ACCESSORY_JSON(
			"accessory_json"), SHIELD_JSON("shield_json"), CLOTHES_JSON("clothes_json"), CONSUMABLES_JSON(
			...
			"monster_field_json"), UNUSUAL_CONDITION_JSON("unusual_condition_json");
