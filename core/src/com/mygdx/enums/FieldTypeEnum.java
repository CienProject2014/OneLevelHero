...
public enum FieldTypeEnum {
	CRYSTALLIZED_VALLEY("crystallized_valley"), RANGE_OF_A_MOUNTAIN_TITANIA("range_of_a_mountain_titania"), MOUNTAIN_TIANIA(
			"mountain_titania"), CAVE_OF_SUCCUBUS("cave_of_succubus"), GOLDEN_LAKE("golden_lake"), CAVE_OF_CAPE_OF_TEMPEST(
			...
			"devil_castle_3f"), BLACKWOOD_MOUNTAIN("blackwood_mountain"), KADILLA_MOUNTAIN("kadilla_mountain"), ELVEN_FOREST(
